  ...
  return (
    <div className="card-elevated">
      <div className="mb-6">
          ...
          <div className="flex gap-2 items-center">
            <div className="relative">
              <input 
                ...
                className="p-2 pr-8 text-sm rounded-md border border-[var(--primary-200)]/30 bg-[var(--background-50)] w-full"
              />
              <Search className="absolute right-2 top-2 opacity-50 w-4 h-4" />
            </div>
            
            <motion.button
              onClick={() => setShowFilters(!showFilters)}
              className={`p-2 rounded-md ${showFilters ? 'bg-[var(--primary-100)]' : 'bg-[var(--background-100)]'}`}
              whileTap={{ scale: 0.95 }}
            >
              <Filter size={18} />
            </motion.button>
            ...
            <motion.button
              className="p-2 rounded-md bg-[var(--background-100)]"
              whileTap={{ scale: 0.95 }}
        ...
        {showFilters && (
          <motion.div 
            className="mt-4 p-4 rounded-lg bg-[var(--background-100)] grid grid-cols-1 sm:grid-cols-3 gap-4"
          ...
          >
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none w-full p-2 rounded-md border border-[var(--primary-200)]/30 bg-[var(--background-50)] text-sm"
                >
                ...
                <ChevronDown size={16} className="absolute right-2 top-2.5 opacity-50" />
              </div>
            </div>
            ...
            <div className="flex items-end">
              <button
                ...
                className="p-2 text-sm w-full bg-[var(--background-50)] border border-[var(--primary-200)]/30 rounded-md hover:bg-[var(--primary-100)]"
              >
                Clear Filters
              </button>
            </div>
      ...
      {filteredTransactions.length > 0 ? (
        ...
        <div className="py-12 text-center">
          <div className="flex justify-center mb-3">
            <AlertCircle size={48} className="text-[var(--primary-400)] opacity-50" />
          </div>
